...
class Sensor:
    ...
    def __init__(self, identifier: str) -> None:
        ...
        # Since all hamilton sensors have at least two channels we should replace
        # this variable with a dict i.e. {"primary": 4.1, "secondary": 30.5}, but
        # that would mean updating the opc server as well :'(
        self.value = 9999
...
class HamiltonSensor(Sensor):
    ...
    def __init__(self, identifier, address, port="/dev/ttyUSB0", baudrate=19200, timeout=1):
        supper().__init__(identifier)
