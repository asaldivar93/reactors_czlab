"""Hamilton sensor adapter over the shared Modbus transport."""
...
from reactors_czlab.drivers.modbus import (
    REGISTERS_PER_VALUE,
    ModbusError,
    ModbusRequest,
    valid_baudrates,
...
if TYPE_CHECKING:
    from reactors_czlab.drivers.modbus import ModbusHandler
...
class HamiltonSensor(Sensor):
    ...
    #: Aliased from hamilton_model so there is one list, not two that can
